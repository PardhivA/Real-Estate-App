...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            setError(false)
            alert('created a new listing successfully')
      ...
      <div className='flex gap-4'>
        ...
        <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button disabled={loading || uploading} className='p-3  bg-zinc-300 text-zinc-700 rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading ? 'Uploading' : 'Create Listing'}</button>
